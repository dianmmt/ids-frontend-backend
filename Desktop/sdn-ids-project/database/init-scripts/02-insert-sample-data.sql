...
-- ============================================================================
INSERT INTO ml_models (model_name, model_version, model_type, accuracy, precision_score, recall_score, f1_score, status, is_active, training_data_size, training_duration_seconds, folder_path) VALUES
('RandomForest_IDS_v1', '1.0.0', 'Random Forest', 0.9456, 0.9234, 0.9567, 0.9398, 'active', true, 100000, 3600, '/models/classic/'),
('NeuralNetwork_IDS_v1', '1.0.0', 'Neural Network', 0.9234, 0.9123, 0.9345, 0.9232, 'active', false, 100000, 7200, '/models/dnn/'),
('XGBoost_IDS_v1', '1.0.0', 'XGBoost', 0.9567, 0.9456, 0.9678, 0.9567, 'training', false, 100000, 1800, '/models/xgb/'),
('LSTM_Anomaly_v1', '1.0.0', 'LSTM', 0.9123, 0.9012, 0.9234, 0.9123, 'active', true, 50000, 10800, '/models/lstm/'),
('Traffic_Classifier_v2', '2.0.0', 'TensorFlow', 0.9180, 0.9020, 0.9320, 0.9160, 'active', false, 150000, 14400, '/models/tf/traffic_classifier/'),
('Anomaly_Detector_RF_v2', '2.1.0', 'Random Forest', 0.9420, 0.9300, 0.9510, 0.9400, 'active', false, 200000, 5400, '/models/rf/anomaly_detector/')
