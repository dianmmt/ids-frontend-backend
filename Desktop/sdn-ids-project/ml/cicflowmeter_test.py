#!/usr/bin/env python3
"""
CICFlowMeter Feature Test Script for Random Forest Model
Tests the model with proper CICFlowMeter feature mapping
"""
...
def main():
    print("=== CICFlowMeter Random Forest Model Test ===")
    sys.stdout.flush()
    ...
    try:
        ...
        # Create sample CICFlowMeter data with all the features you provided
        print("Creating sample CICFlowMeter data...")
        sys.stdout.flush()
        ...
        print(f"Sample data contains {len(sample_cicflowmeter_data)} features")
        sys.stdout.flush()
        ...
        for cicflowmeter_name, internal_name in feature_mapping.items():
            if cicflowmeter_name in sample_cicflowmeter_data:
                mapped_data[internal_name] = sample_cicflowmeter_data[cicflowmeter_name]
            else:
        ...
        # Create feature array with correct number of features (77)
        expected_features = [
        ...
        print(f"Expected features: {model.n_features_in_}")
        print(f"Prediction: {prediction}")
        print(f"Confidence: {confidence:.3f}" if 'confidence' in locals() else "Confidence: N/A")
        print(f"Is Malicious: {is_malicious}")
        print("=== Test Complete ===")
        sys.stdout.flush()
